...
export class SongPlayerLayoutPrompt implements Prompt {
	...
	constructor(private _doc: SongDocument) {
		...
		(<any> this._form.elements)["spLayout"].value = this._doc.prefs.spLayout;
	}
	...
	private _confirm = (): void => { 
		this._doc.prefs.spLayout = (<any> this._form.elements)["spLayout"].value;
		this._doc.prefs.save();
		SongPlayerLayout.setLayout(this._doc.prefs.spLayout);
		this._close();
	}
}
